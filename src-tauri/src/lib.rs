...
pub fn run() {
    ...
    let app = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::codex::codex_local_access_test_upstream,
            commands::codex::codex_local_access_create_service,
            commands::codex::codex_local_access_rename_service,
            commands::codex::codex_local_access_delete_service,
            commands::codex::codex_local_access_select_service,
